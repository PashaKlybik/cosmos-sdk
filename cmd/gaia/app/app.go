...
func (h StakingHooks) BeforeDelegationSharesModified(ctx sdk.Context, delAddr sdk.AccAddress, valAddr sdk.ValAddress) (sdk.Coins) {
	coins := h.dh.BeforeDelegationSharesModified(ctx, delAddr, valAddr)
